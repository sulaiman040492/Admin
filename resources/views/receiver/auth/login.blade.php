				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					<div class="d-flex flex-center flex-column flex-column-fluid">
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form method="POST" action="{{ route('receiver.login') }}" class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
								...
								<div class="text-center mb-10">
									...
									<a href="{{route('receiver.register')}}" class="link-primary fw-bolder">Create an Account</a></div>
								</div>
                                ...
                                <div class="fv-row mb-10">
                                    <div class="d-flex flex-stack mb-2">
                                        <a href="{{route('receiver.password.request')}}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                                    </div>
                                </div>
