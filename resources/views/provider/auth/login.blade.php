				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					<div class="d-flex flex-center flex-column flex-column-fluid">
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form method="POST" action="{{ route('provider.login') }}" class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
                                    @csrf
								<div class="text-center mb-10">
									<h1 class="text-dark mb-3">Sign In to Island Care</h1>
									<div class="text-gray-400 fw-bold fs-4">New Here?
									<a href="{{route('provider.register')}}" class="link-primary fw-bolder">Create an Account</a></div>
								</div>
                                ...
                                <div class="fv-row mb-10">
                                    <a href="{{route('provider.password.request')}}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                                </div>
