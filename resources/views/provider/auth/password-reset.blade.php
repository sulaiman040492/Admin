					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							@if (session('status'))
								...
								@endif
							{{-- <form method="POST" action="{{url('provider.password.email')}}" class="form w-100" novalidate="novalidate" id="kt_password_reset_form1"> --}}
							<form method="POST" action="{{route('provider.password.email')}}" class="form w-100" id="kt_password_reset_form1">
								@csrf
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="{{route('provider.login')}}" class="btn btn-lg btn-light-primary fw-bolder">Cancel</a>
								</div>
							</form>
						</div>
					</div>
