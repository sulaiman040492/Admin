...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <a href="{{route('provider.category.create')}}" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder">
                          ...
                          @foreach($category as $key => $cate)
                            ...
                            <!-- data-bs-toggle="modal" data-bs-target="#kt_modal_new_target" -->
															<a href="{{route('provider.category.edit',$cate->id)}}" method="GET" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
                              ...
                              <form method="POST" id="delete-form-{{$cate->id}}" action="{{route('provider.category.destroy',$cate->id)}}">
                                @csrf
                                @method('DELETE')
                              </form>
														</td>
