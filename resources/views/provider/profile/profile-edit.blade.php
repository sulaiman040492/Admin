...
@section('content')
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							@include('provider.profile.profile-header',['file'=>'profile-edit'])
								...
								<div class="card">
									...
									<form id="kt_project_settings_form_custom" class="form" action="{{route('provider.profileUpdate')}}" method="POST" enctype="multipart/form-data">
										@csrf
										<div class="card-body p-9">
											<div class="row mb-5">
												...
												<div class="col-lg-8">
													<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/avatars/blank.png')">
														...
														@if(Auth::guard('provider')->user()->image != null)
														background-image: url('{{asset('provider/images/avatars/').'/'.Auth::guard('provider')->user()->image}}')
														@else
														background-image: url('{{asset('provider/images/avatars/default.png')}}')
														@endif
														"></div>
											...
											<div class="row mb-8">
												...
												<input type="hidden" name="id" value="@if(Auth::guard('provider')->user()->id != null) {{Auth::guard('provider')->user()->id}} @endif" />
													<input type="text" class="form-control form-control-solid" name="fname" value="@if(Auth::guard('provider')->user()->first_name != null) {{Auth::guard('provider')->user()->first_name}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<input type="text" class="form-control form-control-solid" name="lname" value="@if(Auth::guard('provider')->user()->last_name != null) {{Auth::guard('provider')->user()->last_name}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<input type="email" class="form-control form-control-solid" name="email" value="@if(Auth::guard('provider')->user()->email != null) {{Auth::guard('provider')->user()->email}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
												@if(Auth::guard('provider')->user()->date_of_birth != null)
													<input type="text" class="form-control form-control-solid" name="date_of_birth" id="dob_old" value="{{Auth::guard('provider')->user()->date_of_birth}}" readonly/>
												@endif
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<input type="text" class="form-control form-control-solid" name="phone" value="@if(Auth::guard('provider')->user()->phone_no != null) {{Auth::guard('provider')->user()->phone_no}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<textarea name="address" class="form-control form-control-solid h-60px">@if(Auth::guard('provider')->user()->address != null) {{Auth::guard('provider')->user()->address}} @endif</textarea>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
												<input type="text" class="form-control form-control-solid" name="postal" value="@if(Auth::guard('provider')->user()->postal != null) {{Auth::guard('provider')->user()->postal}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<textarea name="city" class="form-control form-control-solid h-60px">@if(Auth::guard('provider')->user()->city != null) {{Auth::guard('provider')->user()->city}} @endif</textarea>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<textarea name="country" class="form-control form-control-solid h-60px">@if(Auth::guard('provider')->user()->country != null) {{Auth::guard('provider')->user()->country}} @endif</textarea>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<input type="text" class="form-control form-control-solid" name="hourly_rate" value="@if(Auth::guard('provider')->user()->hourly_rate != null) {{Auth::guard('provider')->user()->hourly_rate}} @endif" />
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<input type="text" class="form-control form-control-solid" name="degree_title" value="@if(isset(Auth::guard('provider')->user()->degree) && Auth::guard('provider')->user()->degree != null) {{Auth::guard('provider')->user()->degree}} @endif"/>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="">
													<input class="form-control form-control-solid" name="institute_name" value="@if(isset(Auth::guard('provider')->user()->institute) && Auth::guard('provider')->user()->institute != null) {{Auth::guard('provider')->user()->institute}} @endif"/>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="">
													@if(isset($edu->from_date) && $edu->from_date != null)
														<input type="text" class="form-control form-control-solid" name="from_date_ed" id="from_date_ed_old" value="{{Auth::guard('provider')->user()->education_from}}" readonly/>
													@endif
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="">
													@if(isset($edu->to_date) && $edu->to_date != null)
														<input type="text" class="form-control form-control-solid" name="to_date_ed" id="to_date_ed_old" value="{{Auth::guard('provider')->user()->education_to}}" readonly/>
													@endif
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="kt_modal_new_target_form">
													<input class="form-control form-control-solid"  name="job_title" value="@if(isset(Auth::guard('provider')->user()->job_title) && Auth::guard('provider')->user()->job_title != null) {{Auth::guard('provider')->user()->job_title}} @endif"/>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="kt_modal_new_target_form">
													<input class="form-control form-control-solid" name="company_name" value="@if(isset(Auth::guard('provider')->user()->company) && Auth::guard('provider')->user()->company != null) {{Auth::guard('provider')->user()->company}} @endif"/>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="kt_modal_new_target_form">
													<input class="form-control form-control-solid" name="experience" value="@if(isset(Auth::guard('provider')->user()->experience) && Auth::guard('provider')->user()->experience != null) {{Auth::guard('provider')->user()->experience}} @endif"/>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="kt_modal_new_target_form">
													@if(isset(Auth::guard('provider')->user()->experience_from) && Auth::guard('provider')->user()->experience_from != null)
														<input type="text" class="form-control form-control-solid" name="from_date_ex" id="from_date_ex_old" value="{{Auth::guard('provider')->user()->experience_from}}" readonly/>
													@endif
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row" id="kt_modal_new_target_form">
													@if(isset(Auth::guard('provider')->user()->experience_to) && Auth::guard('provider')->user()->experience_to != null)
														<input type="text" class="form-control form-control-solid" name="to_date_ex" id="to_date_ex_old" value="{{Auth::guard('provider')->user()->experience_to}}" readonly/>
													@endif
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<textarea name="availability" class="form-control form-control-solid h-150px">@if(Auth::guard('provider')->user()->availability != null) {{Auth::guard('provider')->user()->availability}} @endif</textarea>
												</div>
											</div>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9 fv-row">
													<textarea name="description" class="form-control form-control-solid h-150px">@if(Auth::guard('provider')->user()->description != null) {{Auth::guard('provider')->user()->description}} @endif</textarea>
												</div>
											</div>
