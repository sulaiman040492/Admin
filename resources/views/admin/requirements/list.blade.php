...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
										...
										<small class="text-muted fs-7 fw-bold my-1 ms-1">Requirements</small>
									</h1>
								</div>					
							</div>
						</div>
								...
								<div class="card mb-5 mb-xl-8">
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Requirements</span>
                        ...
                        <a href="{{route('admin.requirement.create')}}" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder">
...
<rect x="6.01041" y="10.9247" width="12" height="2" rx="1" fill="black" opacity="0.6"/>
                          ...
                          @foreach($res as $key => $res)
                            ...
                            <!-- data-bs-toggle="modal" data-bs-target="#kt_modal_new_target" -->
															<a href="{{route('admin.requirement.edit',$res->id)}}" method="GET" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
                              ...
                              <form method="POST" id="delete-form-{{$res->id}}" action="{{route('admin.requirement.destroy',$res->id)}}">
                                @csrf
                                @method('DELETE')
                              </form>
														</td>
