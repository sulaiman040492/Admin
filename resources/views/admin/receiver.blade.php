        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                    ...
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Service Receiver</small>
                </h1>
            </div>					
        </div>
    </div>
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Service Receiver</span>
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Geoge</h6>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">
                                        ...
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm kt_data_delete_table_ok">
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary fs-6">XD-2</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Lee</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">royGeroge@gmail.com</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Nany</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary fs-6">XD-3</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Jhon</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">royGeroge@gmail.com</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Pet Caregiver</h6>
                                    </td>

                                    <td>
                                        <span class="badge badge-light-danger">Non Approved</span>
                                    </td>
                                    <td class="text-end">
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">
                                            <span class="svg-icon svg-icon-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary fs-6">XD-4</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Roy</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">royGeroge@gmail.com</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Compaion Caregiver</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary fs-6">XD-5</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">Aron</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">royGeroge@gmail.com</h6>
                                    </td>
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <form id="kt_modal_new_target_form" class="form" action="#">
                                <div class="mb-13 text-center">
                                    <h1 class="mb-3">Edit Service Receiver</h1>
