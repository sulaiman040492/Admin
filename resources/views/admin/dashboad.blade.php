                ...
                <div class="col-xxl-8">
                    <div class="card card-xxl-stretch">
                        <div class="card-header border-0 bg-danger py-5">
                            <h3 class="card-title fw-bolder text-white">Total Earnings</h3>
                        </div>
                            ...
                            <div class="card-p mt-n20 position-relative">
                                <div class="row g-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning fw-bold fs-6">New Userss</a>
                                    </div>
                                    ...
                                    <div class="col bg-light-info px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <a href="#" class="text-info fw-bold fs-6">New Notifications</a>
                                    </div>
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <a href="#" class="text-danger fw-bold fs-6 mt-2">Total Subscriber</a>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0">
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 me-7">
                                        ...
                                        <a href="#" class="text-primary fw-bold fs-6">New Subscription Request</a>
                                    </div>

                                    <div class="col bg-light-dark px-6 py-8 rounded-2 me-7">
                                        ...
                                        <a href="#" class="text-dark fw-bold fs-6 mt-2">Pending Subscription Request</a>
                                    </div>
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-2">
                                        ...
                                        <a href="#" class="text-success fw-bold fs-6 mt-2">Daily Sale</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-xxl-stretch">
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bolder mb-2 text-dark">News</span>
                            </h3>
                        ...
                        <div class="card-body pt-5">
                            <div class="timeline-label">
                                <div class="timeline-item">
                                    <div class="timeline-label fw-bolder text-gray-800 fs-6">23/1/2021</div>

                                    <div class="timeline-badge">
                                        <i class="fa fa-genderless text-warning fs-1"></i>
                                    </div>

                                    <div class="fw-mormal timeline-content text-muted ps-3">John's Subscription has Expired</div>
                                </div>

                                <div class="timeline-item">
                                    <div class="timeline-label fw-bolder text-gray-800 fs-6">22/1/2021</div>
                                    ...
                                    <div class="timeline-content d-flex">
                                        <span class="fw-bolder text-gray-800 ps-3">Rock activated 1 year of subscription</span>
                                    </div>
                                </div>

                                <div class="timeline-item">
                                    <div class="timeline-label fw-bolder text-gray-800 fs-6">20/1/2021</div>

                                    <div class="timeline-badge">
                                        <i class="fa fa-genderless text-danger fs-1"></i>
                                    </div>

                                    <div class="timeline-content fw-bolder text-gray-800 ps-3">Harry activated 3 months of subscription</div>
                                </div>

                                <div class="timeline-item">
                                    <div class="timeline-label fw-bolder text-gray-800 fs-6">19/1/2021</div>

                                    <div class="timeline-badge">
                                        <i class="fa fa-genderless text-primary fs-1"></i>
                                    </div>

                                    <div class="timeline-content fw-mormal text-muted ps-3">Jim activated 1 months of subscription</div>
                                </div>
                ...
                <div class="col-xl-12">
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Latest Subscription Statistics</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Over 500 Subscription</span>
                            </h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bolder fs-6 text-gray-800">22 Dec 2021</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                <span class="fw-bolder fs-6 text-gray-800">Service Provider</span>
                                            </td>
                                            <td class="text-end">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    ...
                                                    <a href="#" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm kt_data_delete_table_ok">
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bolder fs-6 text-gray-800">20 Dec 2021</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                <span class="fw-bolder fs-6 text-gray-800">Service Receiver</span>
                                            </td>
                                            <td class="text-end">
                                                <div class="d-flex flex-column w-100 me-2">
                                                    <span class="badge badge-danger">Non-Verified</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bolder fs-6 text-gray-800">16 Dec 2021</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bolder fs-6 text-gray-800">12 Dec 2021</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bolder fs-6 text-gray-800">06 Dec 2021</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted fw-bold fs-7">Last 6 Months</span>
                            </h3>
                        </div>
