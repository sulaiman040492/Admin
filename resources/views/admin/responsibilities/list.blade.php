...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
										...
										<small class="text-muted fs-7 fw-bold my-1 ms-1">Responsibilities</small>
									</h1>
								</div>					
							</div>
						</div>
								...
								<div class="card mb-5 mb-xl-8">
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Responsibilities</span>
                        ...
                        <a href="{{route('admin.responsibility.create')}}" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder">
						<span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<rect opacity="0.01" x="2" y="2" width="20" height="20" rx="10" fill="#00000000"/>
<rect x="10.8891" y="17.8033" width="12" height="2" rx="1" transform="rotate(-90 10.8891 17.8033)" fill="black"/>
<rect x="6.01041" y="10.9247" width="12" height="2" rx="1" fill="black" opacity="0.6"/>
</svg>
														</span>
                          ...
                          @foreach($res as $key => $res)
													<tr>														
														<td>
															<h6 class="text-dark fw-normal text-hover-primary d-block mb-1 fs-6">{{$res->value}}</h6>
														</td>
														
														<td class="text-end">
                            <!-- data-bs-toggle="modal" data-bs-target="#kt_modal_new_target" -->
															<a href="{{route('admin.responsibility.edit',$res->id)}}" method="GET" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
															...
															<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm kt_data_delete_table_ok_category" id="{{$res->id}}">
																<span class="svg-icon svg-icon-3">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                              ...
                              <form method="POST" id="delete-form-{{$res->id}}" action="{{route('admin.responsibility.destroy',$res->id)}}">
                                @csrf
                                @method('DELETE')
                              </form>
														</td>
