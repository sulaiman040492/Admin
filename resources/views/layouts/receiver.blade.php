					...
					<div class="aside-menu flex-column-fluid">
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">								
								...
								<div class="menu-item">
									<a class="menu-link active" href="{{route('receiver.dashboard')}}">
								...
								<div class="menu-item">
									<a class="menu-link" href="{{route('receiver.jobtype')}}">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
									<a class="menu-link" href="{{route('receiver.profile')}}">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M6.28548 15.0861C7.34369 13.1814 9.35142 12 11.5304 12H12.4696C14.6486 12 16.6563 13.1814 17.7145 15.0861L19.3493 18.0287C20.0899 19.3618 19.1259 21 17.601 21H6.39903C4.87406 21 3.91012 19.3618 4.65071 18.0287L6.28548 15.0861Z" fill="black"></path>
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												...
												src="{{asset('receiver/images/avatars/'.Auth::guard('receiver')->user()->image)}}"
												@else
												src="{{asset('receiver/images/avatars/default.png')}}"
												@endif
												alt="user" />
											</div>
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::guard('receiver')->user()->first_name }} {{ Auth::guard('receiver')->user()->last_name }}</div>
															<a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::guard('receiver')->user()->email }}</a>
														</div>
													</div>
												</div>
												...
												<div class="menu-item px-5">
													<a href="{{route('receiver.profile')}}" class="menu-link px-5">My Profile</a>
												</div>
												...
												<div class="menu-item px-5">
													<a href="{{route('receiver.logout')}}" class="menu-link px-5">Sign Out</a>
												</div>
											</div>
										</div>
									</div>
