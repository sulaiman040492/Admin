				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					<div class="d-flex flex-center flex-column flex-column-fluid">
						<div class="w-lg-600px p-10 p-lg-15 mx-auto">
							...
							<form method="POST" action="{{ route('client.register') }}" class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
								@csrf
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-xl-6">
										...
										<select class="form-select form-select-solid @error('service_id') border-danger is-invalid @enderror" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member" name="service_id">
											...
											<option value="1" {{(old('service_id') == 1) ? "selected" : ''}}>Nanny</option>
											<option value="2" {{(old('service_id') == 2) ? "selected" : ''}}>Senior Caregiver</option>
											<option value="3" {{(old('service_id') == 3) ? "selected" : ''}}>Companion Caregiver</option>
											<option value="4" {{(old('service_id') == 4) ? "selected" : ''}}>Pet Caregiver</option>
											<option value="5" {{(old('service_id') == 5) ? "selected" : ''}}>House Caregiver</option>
											<option value="6" {{(old('service_id') == 6) ? "selected" : ''}}>Tutor</option>
											<option value="7" {{(old('service_id') == 7) ? "selected" : ''}}>Day Care</option>
											<option value="8" {{(old('service_id') == 8) ? "selected" : ''}}>Junior Babysitter</option>
											<option value="9" {{(old('service_id') == 9) ? "selected" : ''}}>Mature Babysitter</option>
										</select>
										@error('service_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
