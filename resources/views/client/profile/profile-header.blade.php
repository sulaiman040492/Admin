												...
												<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
													<div class="d-flex flex-column">
														<div class="d-flex align-items-center mb-2">
															<a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">@if(Auth::guard('client')->user()->first_name != null) {{Auth::guard('client')->user()->first_name}} @endif @if(Auth::guard('client')->user()->last_name != null) {{Auth::guard('client')->user()->last_name}} @endif</a>
														...
														@if(isset(Auth::guard('client')->user()->experience) && Auth::guard('client')->user()->experience != null)
														<div class="d-flex flex-wrap fw-bold fs-6 mb-1 pe-2">
															<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
																...
																{{Auth::guard('client')->user()->experience}} years experience
															</a>
														</div>
														@endif

														@if(isset(Auth::guard('client')->user()->hourly_rate) && Auth::guard('client')->user()->hourly_rate != null)
														<div class="d-flex flex-wrap fw-bold fs-6 mb-1 pe-2">
															<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
																<span class="svg-icon svg-icon-4 me-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																...
																${{Auth::guard('client')->user()->hourly_rate}} /hour
															</a>
														</div>
														@endif

														<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
															@if(Auth::guard('client')->user()->address != null)
															<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
																<span class="svg-icon svg-icon-4 me-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<div class="d-flex overflow-auto h-55px">
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
												...
												<li class="nav-item w-80px">
													<a class="nav-link text-active-primary me-6 {{$file == 'profile' ?  'active' : ''}}" href="{{route('client.profile')}}">
														Profile
													</a>
												</li>

												<li class="nav-item w-120px">
													<a class="nav-link text-active-primary me-6 {{$file == 'profile-edit' ?  'active' : ''}}" href="{{route('client.profileEdit')}}">
														Edit Profile
													</a>
												</li>

												<li class="nav-item w-180px">
													<a class="nav-link text-active-primary me-6 {{$file == 'password-change' ?  'active' : ''}}" href="{{route('client.passwordChange')}}">
														Change Password
													</a>
												</li>
												...
												<li class="nav-item w-120px">
													<a class="nav-link text-active-primary me-6 {{$file == 'password-membership' ?  'active' : ''}}" href="{{route('client.profileMembership')}}">
														Membership
													</a>
												</li>
