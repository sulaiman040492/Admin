...
class RegisterController extends Controller
{
    ...
    protected function create(array $data)
    {
        return Provider::create([
            ...
            if(Auth::guard('provider')->attempt($data->only('email','password'))){
                return redirect()
    ...
    public function showRegistrationForm()
    {
        ...
        return view('provider.auth.sign-up',compact('categories'))->with('form_msg', 'Please register and wait for approval call');
    }
