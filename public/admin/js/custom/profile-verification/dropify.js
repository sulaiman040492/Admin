    ...
    return (
        ...
        (e.prototype.createElements = function () {
            ...
            i(this.settings.tpl.errorLine).appendTo(e),
                ...
                this.settings.showLoader === !0 && ((this.loader = i(this.settings.tpl.loader)), this.loader.insertBefore(this.input)),
                (this.preview = i(this.settings.tpl.preview)),
                this.preview.insertAfter(this.input),
                this.isDisabled === !1 && this.settings.showRemove === !0 && ((this.clearButton = i(this.settings.tpl.clearButton)), this.clearButton.insertAfter(this.input), this.clearButton.on("click", this.clearElement)),
                (this.filenameWrapper = i(this.settings.tpl.filename)),
                this.filenameWrapper.prependTo(this.preview.find(".dropify-infos-inner")),
                this.settings.showErrors === !0 &&
                    ((this.errorsContainer = i(this.settings.tpl.errorsContainer)), "outside" === this.settings.errorsPosition ? this.errorsContainer.insertAfter(this.wrapper) : this.errorsContainer.insertBefore(this.input));
        ...
        (e.prototype.getError = function (i) {
            ...
            return (
                "fileSize" === i
                    ...
                    : "imageFormat" === i && (t = this.settings.allowedFormats.join(" ")),
