...
var KTWidgets = {
    init: function () {
        var e, t, a, o, s, r, i, l, n, c, d, h, su, xe;
        !(function () {
            ...
            [].slice.call(t).map(function (e) {
                ...
                if (e) {
                    ...
                    new ApexCharts(e, {
                        series: [{ name: "Fees", data: [30, 45, 32, 70, 40, 20, 5] }],
                        ...
                        xaxis: {
                            categories: ["Monday", "Tuesday", "Wednesday", "Thusday", "Frida", "Saturday", "Sunday"],
                            axisBorder: { show: !1 },
                            axisTicks: { show: !1 },
            ...
            (su = KTUtil.getCssVariableValue("--bs-success")),
            (xe = KTUtil.getCssVariableValue("--bs-info")),
            (l = KTUtil.getCssVariableValue("--bs-gray-300")),
            a &&
                new ApexCharts(a, {
                    series: [
                        { name: "2019", data: [44, 55, 57, 56, 61, 58] },
                        { name: "2020", data: [76, 85, 101, 98, 87, 105] },
                        { name: "2021", data: [96, 92, 120, 150, 101, 160] },
                    ],
                        ...
                        h.classList.contains("btn-success")
                            ...
                            : setTimeout(function () {
                                  h.removeAttribute("data-kt-indicator"),
                                      ...
                                      (h.querySelector(".indicator-label").innerHTML = "A"),
                                      (h.disabled = !1);
                              }, 1e3);
                }),
            (function () {
