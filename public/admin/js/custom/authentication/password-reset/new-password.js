        ...
        init: function () {
            (e = document.querySelector("#kt_new_password_form")),
                ...
                (r = FormValidation.formValidation(e, {
                    fields: {
                        "old-password": { validators: { notEmpty: { message: "Old Password is required" } } },
                        password: {
                            validators: {
                                ...
                                ? (t.setAttribute("data-kt-indicator", "on"),
                                  ...
                                  setTimeout(function () {
                                      t.removeAttribute("data-kt-indicator"),
                                          (t.disabled = !1),
                                          Swal.fire({ text: "You have successfully update your password!", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(
                                              function (t) {
